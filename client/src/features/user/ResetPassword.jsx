...
function ResetPassword() {
  ...
  return (
    <motion.form
      ...
      initial="hidden"
      animate="visible"
      className="relative flex flex-col gap-8 overflow-hidden rounded-[3rem] border border-stone-700/50 bg-[#283039]/30 p-10 shadow-2xl backdrop-blur-md"
      onSubmit={handleSubmit(submit)}
    >
      {/* Decorative background elements */}
      <div className="absolute -top-24 -right-24 -z-10 h-64 w-64 rounded-full bg-blue-600/10 blur-[100px]" />
      <div className="absolute -bottom-24 -left-24 -z-10 h-64 w-64 rounded-full bg-purple-600/10 blur-[100px]" />
      ...
      <header className="relative z-10 space-y-3">
        ...
        <p className="max-w-md text-lg leading-relaxed text-stone-400">
          Almost there! Enter the 6-digit code we sent you and set your new
          password.
        </p>
      </header>
          ...
          >
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A10.003 10.003 0 003.112 11c0-5.523 4.477-10 10-10s10 4.477 10 10a10.003 10.003 0 01-2.212 6.44l-.054.09m-3.44 2.04C15.009 17.799 14 14.517 14 11"
              />
            </svg>
            Reset Code
          </label>
