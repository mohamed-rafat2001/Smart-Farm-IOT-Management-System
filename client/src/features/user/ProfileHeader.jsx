...
function ProfileHeader() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -left-24 -bottom-24 h-64 w-64 rounded-full bg-purple-600/5 blur-[100px]" />

      <div className="relative h-40 w-40 shrink-0 group z-10">
        <motion.div
        ...
        >
          ...
          <div 
            onClick={handleImageClick}
            className="absolute inset-0 flex items-center justify-center rounded-[2.5rem] bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer backdrop-blur-[2px]"
          >
            <div className="rounded-full bg-white/10 p-4 backdrop-blur-md border border-white/20 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
        ...
        <button
          onClick={handleImageClick}
          className="absolute -right-2 -bottom-2 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-xl hover:bg-blue-500 transition-all hover:scale-110 active:scale-95 sm:hidden z-30"
        >
        ...
        {isUploading && (
          <div className="absolute inset-0 flex items-center justify-center rounded-[2.5rem] bg-black/60 backdrop-blur-sm z-20">
        ...
        {uploadStatus?.includes('successful') && !isUploading && (
          <motion.div
            ...
            className="absolute -top-3 -right-3 rounded-2xl bg-green-500 p-3 shadow-lg z-20 border-4 border-[#1b2127]"
          >
      ...
      <div className="flex-grow text-center min-[450px]:text-left space-y-6 z-10">
        ...
        <motion.div 
          ...
          className="flex flex-wrap items-center justify-center min-[450px]:justify-start gap-4"
        >
